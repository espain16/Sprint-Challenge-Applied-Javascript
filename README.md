...
The DOM is basically the bridge that connects the browser to HTML, so the browser can understand the HTML.

2. What is an event?

An event is when the browser can detect all the interactions a user has with the browser.
